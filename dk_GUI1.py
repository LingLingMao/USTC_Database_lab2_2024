...
label5 = tk.Label(root, text="宿舍号")
label5.place(x=50, y=250)
entry5 = tk.Entry(root)
entry5.place(x=100, y=250)
label6 = tk.Label(root, text="宿舍楼")
label6.place(x=50, y=300)
entry6 = tk.Entry(root)
entry6.place(x=100, y=300)
label7 = tk.Label(root, text="照片名")
label7.place(x=50, y=350)
entry7 = tk.Entry(root)
entry7.place(x=100, y=350)

# 按钮
button1 = tk.Button(root, text="插入学生信息", command=on_button1_click)
button1.place(x=50, y=400)
button2 = tk.Button(root, text="删除学生信息", command=on_button2_click)
button2.place(x=50, y=450)
button3 = tk.Button(root, text="更新学生信息", command=on_button3_click)
button3.place(x=50, y=500)
button4 = tk.Button(root, text="查询学生照片", command=on_button4_click)
